...
<nav class="navbar navbar-expand-lg sticky-top">
    ...
    <div class="row">
                            ...
                            <div class="modal-body">
                                <form class="mb-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="width:100%;" class="form-control" id="blog-title" aria-describedby="blogtitle" placeholder="Enter Title of Blog...">
       ...
       <div class=" row mt-3 m-0">
            ...
            <div class="col-md-5 card blog">
                <img src="../assets/aerial-photography-aerial-shot-architecture-1959065.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Artificial Island</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="#" class="btn btn-primary">Read more</a>
                </div>
            </div>
